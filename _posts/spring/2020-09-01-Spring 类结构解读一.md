...
ANSI 8 bit 颜色代码使用 AnsiColor and AnsiBackground。
...
作为注入环境的替代方法，Spring 的 @Value 注释可以用来注入这些属性，前提是
...
典型的情况是完全配置底层命令行解析 API，解析进入 main 方法的参数 String[]，
...
使用 OriginTrackedValue 支持跟踪的 MapPropertySource
